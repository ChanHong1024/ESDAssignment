<%-- 
    Document   : index
    Created on : 2019年11月23日, 下午09:30:58
    Author     : Porygon
--%>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2 mt-2">
                                                <div class="text-xl font-weight-bold text-primary mb-1"><h1><a href="handleAttendance?action=showMyAtt">Attendance Records</a></h1></div>
                                            </div>
                                            <div class="col-auto">
                            ...
                            <div class="col-xl-6 col-md-6 mb-4">
                                <div class="card border-left-success shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <a href="handleAttendance?action=showMyAtt"><div class="text-xl font-weight-bold text-success mb-1"><h1>My School Days</h1></div></a>
                                            </div>
                                            <div class="col-auto">
                                    ...
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mt-4 text-center small">
                                                <span class="mr-2">
                                                    <i class="fas fa-circle text-primary"></i> Attended
                                                </span>
                                                <span class="mr-2">
                                                    <i class="fas fa-circle text-success"></i> Absence
                                                </span>
                                                <span class="mr-2">
                                                    <i class="fas fa-circle text-info"></i> Not started
                                                </span>
                                            </div>
                                        </div>
                                    </div>
